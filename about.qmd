...
3.  A project system for rendering groups of documents at once, sharing options across documents, and producing aggregate output like [books](http://localhost:4318/docs/books/) and [websites](http://localhost:4318/docs/websites/).
