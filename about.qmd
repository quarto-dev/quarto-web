...
Development of Quarto is sponsored by [RStudio, PBC](https://www.rstudio.com), where we previously created a similar system ([R Markdown](https://rmarkdown.rstudio.com/)) that shared the same goals, but was targeted principally at users of the R language. With Quarto, we are hoping to bring these tools to a much wider audience.
