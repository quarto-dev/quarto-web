...
- Use Quarto with [Hugo](docs/output-formats/hugo.qmd), [Docusaurus](docs/output-formats/docusaurus.qmd), or [Confluence](docs/publishing/confluence.qmd) to incorporate notebooks and computations into other publishing systems. 
