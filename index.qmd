...
editor: source
description: | 
  An open source technical publishing system that can render beautiful articles, websites, blogs, books, slides and more with support for Python, R, Julia, and JavaScript.
image: quarto.png
resources: 
