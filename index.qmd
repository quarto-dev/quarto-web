...
resources:
  - images/hero-dark/hero-animation.json
  - images/hero-dark/images/
  - images/hero-light/hero-animation.json
  - images/hero-light/images/
  - js/lottie.min.js
---
...
<p class="h3">An open-source scientific and technical publishing system</p>
...
<p class="h3">Analyze. Share. Reproduce. You have a story to tell with data---tell it with Quarto.</p>
...
```{=html}
<script src="js/lottie.min.js" defer integrity="sha384-J8C0MvgX4WP58J4N2W99vCKd2J6z99ynOJ5bEfE6jeP7kVTW1drYtv/jzrxM5jbm" crossorigin="anonymous"></script>
```
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: 'images/hero-light/hero-animation.json'
    });
  });
</script>
```
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: 'images/hero-dark/hero-animation.json'
    });
  });
</script>
```
