...
### Quarto^[®]{.trademark}^ is an open-source scientific and technical publishing system
...
- Use Quarto with [Hugo](docs/output-formats/hugo.qmd), [Docusaurus](docs/output-formats/docusaurus.qmd), or [Confluence](docs/prerelease/1.3/confluence.qmd) to incorporate notebooks and computations into other publishing systems. 
...
Combine Jupyter notebooks with flexible options to produce elegantly formatted output in a wide variety of formats

::: {.grid}
::: {.g-col-lg-6 .g-col-12}
![](images/hello-jupyter-notebook.png){.hello-output}
:::

::: {.g-col-lg-6 .g-col-12}
![](images/hello-jupyter.png){.hello-output}
:::
:::
...
### You have a story to tell with data---tell it with Quarto.
