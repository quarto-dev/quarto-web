...
For example, at the top level the header in `{{< meta article-file >}}` sets the following keys: `title`, `author`, `keywords`, `abstract`, `key-points`, `date`, `bibliography`, and `citation`.
