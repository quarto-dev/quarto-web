...
-   A notebook file where you write your article. As a {{< meta tool.name >}} user, we recommend you write your article in a notebook called `{{< meta tool.article-file >}}`. This file contains:
