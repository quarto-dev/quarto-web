...
For example, `{{< meta article-file >}}`, includes:
...
The `echo` option describes whether the code is included in the article. If you make this change and save `{{< meta article-file >}}`, you'll see this code now appears in the article. 
