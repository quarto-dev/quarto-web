...
``` markdown
Based on the eruptions up to and including 1971, we would estimate $\lambda$ to be $\frac{1}{`r round(avg_years_between_eruptions, 1)`}$.
```
