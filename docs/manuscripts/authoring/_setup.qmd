...
![Template manuscript open in VS Code](images/vscode-open.png){fig-alt="A screenshot of VS Code. The File Explorer is open showing the folders: _extensions, _freeze, .github, images, and notebooks; and the files: _quarto.yml, index.ipynb, README.md and references.bib." .border}
:::
