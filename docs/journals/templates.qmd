...
Revealjs partials are only available in Quarto v1.2, which you can download at <https://quarto.org/docs/download/prerelease.html>.
:::
...
:   The core Revealjs templates which includes the basic presentation skeleton plus the following partials.
