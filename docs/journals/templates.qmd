...
See the [full source code](https://github.com/quarto-dev/quarto-cli/blob/main/src/resources/formats/html/pandoc/template.html) for the Quarto HTML template to see how these partials are invoked by default.
