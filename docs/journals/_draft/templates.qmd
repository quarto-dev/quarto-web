...
Usually, you use document metadata and content to customize document output. When creating journal specific output, however, you often need fine grained control of the generated output which typically uses journal specific commands and directives.
...
## Combining Templates and Partials
