...
![](images/about-jolla.png){.border .include-dark fig-alt="Screenshot of About page with jolla template. Photo is a centered circle above a heading with the author's name. There is a centered paragraph below the header, a separator line, and then buttons for Bluesky and GitHub centered at the bottom."}
