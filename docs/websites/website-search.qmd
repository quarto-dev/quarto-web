...
::: {.list-table widths="0.08433734939759,0.91566265060241" header-rows="1"}
...
* * `show-item-context`
  ...
  * Control whether page parents are displayed next to items in search results. Use `tree`, `parent`, `root`, or boolean (if true, `tree` is the default). E.g. `tree` results in "Guide \> Authoring \> Figures":
    ...
    ![](images/search-item-context.png){.border width="260" fig-alt="search box with navigational context shown above the title of the first result."}
...
::: {.list-table widths="0.10958904109589,0.89041095890411" header-rows="1"}
...
::: {.list-table widths="0.051502145922747,0.94849785407725" header-rows="1"}
