...
![](images/nav-bar.png){.include-dark fig-alt="A navigation bar. The title 'My Site' is on the left. To the right of the title are the words 'Home', 'Talks', and 'About'. 'Home' is slightly lighter than the other two words. On the far right side of the navigation bar is a search box."}
...
| `logo`           | Logo image to be displayed left of the title. When using a [`_brand.yml`](/docs/authoring/brand.qmd) with a logo, the brand logo is automatically displayed. Use `logo: false` to suppress the brand logo on the navbar.   |
...
![](images/navbar-tools.png){.border .include-dark alt="The right section of a Quarto navbar containing a Bluesky and Github logo. The Github logo is selected and a menu is underneath it with two items: 'Source Code' and 'Report a Bug'"}
:::
...
|                                                                                                                                                                                                                                                                                            |                                                                                                                                                         |
|:--------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------:|
| ![](images/nav-side-anchored.png){.preview-image .include-dark fig-alt="A screenshot of a Quarto document where the sidebar is colored gray."} | ![](images/nav-side-floating.png){.include-dark fig-alt="A screenshot of a Quarto document where the sidebar has a white background and is closer to the body text."} |
:::
...
| `logo`           | Optional logo image. When using a [`_brand.yml`](/docs/authoring/brand.qmd) with a logo, the brand logo is automatically displayed. Use `logo: false` to suppress the brand logo on the sidebar.                                                                   |
| `logo-alt`       | Alternate text for the logo image.                                                                                                                                                                                                                                 |
...
![](images/repo-actions.png){.include-dark fig-alt="A screen shot of a Quarto document. Underneath the page table of contents on the right side are three options: 'Edit this page', 'View source' and 'Report an issue'. There is a Github icon to the left of 'Edit this Page.'"}
