...
1. Titles will be read from the `title` field of documents.
2. Subdirectories will create sections. Use an `index.qmd` in the directory to provide its `title`, otherwise the directory name will be used.
