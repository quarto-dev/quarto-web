...
![](images/positron-create-project-command.png){.include-dark .border fig-alt="Positron command palette with Quarto: Create Project highlighted at the top of the list."}

Then, select **Website Project**:

![](images/positron-create-project-website.png){.include-dark .border fig-alt="Create Quarto Project prompt in Positron, with Website Project selected in the project type list."}
...
![](images/positron-create-project-directory.png){.include-dark .border fig-alt="Project Directory Name prompt in Positron, with an empty text box for the directory name."}
...
![](images/positron-create-project-render.png){.include-dark .border fig-alt="The new website project open in Positron, with index.qmd in the editor and the Preview button in the editor toolbar."}
...
![](images/vscode-create-project-website.png){.border fig-alt="The VS Code Create Quarto Project menu with Website Project selected."}
...
![](images/vscode-create-project-render.png){fig-alt="The new website project open in VS Code, with index.qmd open in the editor. The pointer is on the Preview button in the editor toolbar."}
...
![](images/rstudio-project-website.png){.border fig-alt="RStudio New Project Wizard, Project Type step, with Quarto Website selected."}
:::
...
![](images/rstudio-project-website-preview.png){fig-alt="RStudio with index.qmd open in the visual editor on the left. The rendered website preview shows in the Viewer pane on the right, with a blue navbar titled mywebsite above the home page text."}
