...
![](images/rstudio-no-preview.png){fig-alt="A screenshot of the RStudio IDE with the 'Preview' menu open. The 'No Preview' option is checked to disable the normal preview on render behavior."}
