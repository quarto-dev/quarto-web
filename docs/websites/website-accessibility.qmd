...
The report is GitHub-flavored markdown. Read it where markdown already renders: the preview in your editor, GitHub, or the sticky pull request comment from [the CI recipe below](#checking-accessibility-in-ci). You do not need to render it.
...
| Exit code | Meaning |
|------|--------------------------------------------------------------------|
| `0` | The scan is complete. There are no new findings at or above `--fail-on`, when you gave that flag. |
