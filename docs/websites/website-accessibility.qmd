...
The examples on this page come from a two-page site. It has a navbar, a light theme and a dark theme, an image with no `alt` attribute, and one span of low-contrast text. Quarto also writes an `index.html` that redirects to the first page. The scan sets redirect stubs aside as site furniture and records them, so the matrix covers two pages.
...
note: 1 redirect stub skipped (recorded in findings.json): index.html → notes.html
  gear.html 1440x900 light                                   0  (none)
  gear.html 1440x900 dark                                    0  (none)
  gear.html 320x568 light                                    0  (none)
  gear.html 320x568 dark                                     0  (none)
  notes.html 1440x900 light                                  2  color-contrast,image-alt
  notes.html 1440x900 dark                                   1  image-alt
  notes.html 320x568 light                                   2  color-contrast,image-alt
  notes.html 320x568 dark                                    1  image-alt
...
The matrix matters because a violation can appear in one cell and not in another. In the output above, `image-alt` appears in all four cells of `notes.html`, but `color-contrast` appears only in the light cells. The dark theme gives that text enough contrast.
...
|---|---|---|---|
| notes.html | 1440x900·light, 320x568·light | `p:nth-child(4) > span` | `<span style="color: #bbb">tide table</span>` |
```
