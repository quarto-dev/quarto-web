...
description: "Learn more about using a custom template to build a custom listing display"
comments: 
  hypothesis: true
---
...
To build a custom listing display, you create an EJS template that will be used to generate the HTML for a set of items that are passed to the template. EJS templates allow to generate HTML using plain javascript, making it easy to loop through items and output their values in your custom HTML. You can read more about EJS syntax and functionality [here](https://ejs.co).
