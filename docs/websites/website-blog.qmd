...
![](images/positron-create-project-command.png){.border .include-dark fig-alt="Positron command palette with Quarto: Create Project highlighted at the top of the list."}

Then, select **Blog Project**:

![](images/positron-create-project-blog.png){.border .include-dark fig-alt="Create Quarto Project prompt in Positron, with Blog Project selected in the project type list."}
...
![](images/positron-create-project-directory.png){.border .include-dark fig-alt="Project Directory Name prompt in Positron, with an empty text box for the directory name."}
...
![](images/positron-create-project-render-blog.png){.border .include-dark fig-alt="The new blog project open in Positron, with index.qmd in the editor and the Preview button in the editor toolbar highlighted."}
...
![](images/vscode-create-project-command.png){fig-alt="The VS Code command palette with Quarto: Create Project selected."}

Then, select **Blog Project**:

![](images/vscode-create-project-blog.png){.border fig-alt="The VS Code Create Quarto Project menu with Blog Project selected."}

You'll be prompted to select a parent directory to create the project within. Then, you'll be asked to name the directory for your blog project:

![](images/vscode-create-project-directory.png){.border fig-alt="The VS Code prompt for the Project Directory Name."}
...
![](images/vscode-create-project-render-blog.png){fig-alt="The new blog project open in VS Code, with index.qmd open in the editor. The pointer is on the Preview button in the editor toolbar."}
...
::: {layout-ncol="2"}
![](images/rstudio-project-new-directory.png){.border fig-alt="RStudio New Project Wizard, Create Project step, with New Directory selected."}

![](images/rstudio-project-blog.png){.border fig-alt="RStudio New Project Wizard, Project Type step, with Quarto Blog selected."}
:::

Then, provide a directory name and other relevant options for the blog:

![](images/rstudio-project-blog-options.png){.border fig-alt="RStudio Create Quarto Blog dialog with an empty Directory name field, a subdirectory path, an Engine menu, and options to create a git repository and use the visual markdown editor."}

Click the **Render** button to preview the blog:

![](images/rstudio-project-blog-preview.png){fig-alt="RStudio with the listing YAML of index.qmd on the left. The rendered blog preview shows in the Viewer pane on the right, with a myblog banner above the first post, Post With Code, and its categories, date, and author."}
...
![](images/about-jolla.png){.border .include-dark fig-alt="Screenshot of an about page. It has a large round circle in the top center with an image shown. Below that is a name in large type, with smaller placeholder body text beneath it. There are two buttons at the bottom, one for Bluesky, and one for GitHub."}
