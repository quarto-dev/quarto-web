...
When you render a new post, this page will automatically updated, adding the most recent post to the top of the list. To learn more about listing pages, see [Listing Pages](website-listing.qmd)
