...
::: callout-note
You should be running the [preview release](https://www.rstudio.com/products/rstudio/download/preview/) of RStudio if you want to publish Quarto websites. The preview release has many other Quarto related enhancements so is highly recommended even if you aren't using the publishing features.
:::
