...
::: callout-note
You should be running the [current release](https://www.rstudio.com/products/rstudio/download/) of RStudio if you want to publish Quarto websites. The current release has many other Quarto related enhancements so is highly recommended even if you aren't using the publishing features.
:::
