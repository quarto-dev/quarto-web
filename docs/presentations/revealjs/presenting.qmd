...
- a numeric value to navigate to the desired slide number 
- a string, which will try to locate a slide with a matching id and navigate to it.
...
1.  Toggle into Print View using the {{< kbd E >}} key (or using the [Navigation Menu])
