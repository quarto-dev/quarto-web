...
```{=html}
<iframe class="slide-deck" src="demo/index.html?view=scroll" title="Demo Revealjs presentation in scroll view"></iframe>
```
...
```{=html}
<iframe class="reveal-demo border" src="demo/mini/zoom.html" title="Example slide with images to zoom"></iframe>
```
...
To toggle the notes canvas on and off use the **Toggle Notes Canvas** button <i class="bi bi-brush ui-icon" aria-hidden="true"></i> or the {{< kbd C >}} key.

To toggle the chalkboard on and off use the **Toggle Chalkboard** button <i class="bi bi-easel2 ui-icon" aria-hidden="true"></i> or the {{< kbd B >}} key.
