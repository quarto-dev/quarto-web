...
Reveal presentations be presented in [Scroll View](https://revealjs.com/scroll-view/) with vertically scrolled navigation instead of Slides. This is a new view mode introduced in Revealjs 5. It is is always available in all presentation as an alternative view mode (like [Print view](#print-to-pdf)), and it will be used a default view on small screen (e.g. viewing a presentations on mobile).
...
Scroll View can be made as default mode for the presentation, using default configuration. This can be configure using `scroll-view` configuration.
...
Scroll View in Reveal can be configured using the following option under `scroll-view`.

+--------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Option             | Description                                                                                                                                                                                                                                  |
+====================+==============================================================================================================================================================================================================================================+
| `progress`         | Show the scrollbar while scrolling and hide while idle (default `auto`). Set to `true` to always show, `false` to always hide.                                                                                                               |
+--------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `activation-width` | Control scroll view activation width. The scroll view is automatically unable when the viewport reaches mobile widths. Set to `0` to disable automatic scroll view or to another value to automatically trigger on bigger or smaller widths. |
+--------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `activate`         | Activate scroll view by default for the presentation. Otherwise, entering scroll view require a manual trigger (See [Entering Scroll View]). `scroll-view: true` is equivalent to                                                            |
|                    |                                                                                                                                                                                                                                              |
|                    | ``` yaml                                                                                                                                                                                                                                     |
|                    | scroll-view:                                                                                                                                                                                                                                 |
|                    |   activate: true                                                                                                                                                                                                                             |
...
For example, the following specifies that we want a compact layout with proximity snap mode, and always showing the progress scrollbar while keeping activation to scroll view manual, even disabling on mobile view:
