...
If you prefer to view the demo in a standalone browser you can do that [here](demo/demo.qmd){target="_blank"}. Check out the [source code](https://github.com/quarto-dev/quarto-web/tree/main/docs/presentations/revealjs/demo) for the demo to see how the slides were created.
