...
|                               |                                                                                                                                        |
|-------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| `output-location: fragment`   | Display output as a [Fragment](advanced.qmd#fragments) (delay showing it until its explicitly stepped through by advancing the slides). |
| `output-location: slide`      | Display output on an entirely new slide after the current one.                                                                         |
