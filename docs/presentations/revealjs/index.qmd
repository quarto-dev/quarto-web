...
|                   |                                                                                                                                         |
|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| `fragment`        | Display output as a [Fragment](advanced.qmd#fragments) (delay showing it until its explicitly stepped through by advancing the slides). |
| `slide`           | Display output on an entirely new slide after the current one.                                                                          |
| `column`          | Display output in a column adjacent to the code.                                                                                        |
| `column-fragment` | Display output in a column adjacent to the code (delay showing it until its explicitly stepped through by advancing the slides).        |
