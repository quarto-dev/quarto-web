...
press {{< kbd s >}} (or use the presentation menu) to open speaker view
...
Press {{< kbd r >}} (or use the presentation menu) to open scroll view. This mode will be activated by default on small width screen (e.g. viewing presentation on mobile).

Scroll view behavior can be configured using `scroll-view` configuration.S
