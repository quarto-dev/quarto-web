...
![](https://placekitten.com/300/200){.absolute .fragment bottom="80" right="130" width="300" height="200"}
...
h next couple of slides will transition using the `slide` transition
...
## Interactive Widgets {transition="slide"}

Interactivity with Jupyter Widgets and htmlwidgets for R
...
Use the navigation button at the bottom left of the slide to go to other slides and access presentation tools.
:::

You can also press `m` to toggle the menu open and closed.

::: footer
Learn more: [Navigation Menu](https://quarto.org/docs/presentations/revealjs/presenting.html#navigation-menu)
:::
...
Press `e` to toggle print view, then print to PDF using Chrome. Here's a PDF version of this presentation:

```{=html}
<iframe src="//www.slideshare.net/slideshow/embed_code/key/mhGKYHdhpjhOx9" width="595" height="460" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%; margin: 0 auto; display: block;" allowfullscreen> </iframe> 
```
::: footer
