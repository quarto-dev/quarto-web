...
![](mini/images/kitten-400-350.jpeg){.absolute top="170" left="30" width="400" height="400" fig-alt="Four kittens -- orange, calico, gray tabby, and black -- peering over the rim of a woven basket."}

![](mini/images/kitten-450-250.jpeg){.absolute .fragment top="150" right="80" width="450" fig-alt="Close-up of a tabby kitten sniffing along the edge of a desk, next to a computer mouse."}

![](mini/images/kitten-300-200.jpeg){.absolute .fragment bottom="110" right="130" width="300" fig-alt="A tabby kitten sitting outdoors beside a terracotta plant pot and a wall."}
