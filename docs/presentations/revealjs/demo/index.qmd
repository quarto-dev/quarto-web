...
#| fig-width: 10
#| fig-height: 4.5
#| fig-alt: "Scatterplot of horsepower versus miles per gallon for cars in the mtcars dataset, colored by transmission type, with a loess-smoothed trend line."
library(ggplot2)
...
![](mini/images/kitten-400-350.jpeg){.absolute top="170" left="30" width="400" height="400" fig-alt="Kittens in a basket"}

![](mini/images/kitten-450-250.jpeg){.absolute .fragment top="150" right="80" width="450" fig-alt="Tabby kitten"}

![](mini/images/kitten-300-200.jpeg){.absolute .fragment bottom="110" right="130" width="300" fig-alt="Kitten by a plant pot"}
...
::: {layout-ncol="2"}
![](images/moon.png){fig-alt="Slide titled 'Incremental Lists' rendered in the Moon theme: cream text on a dark teal background."}

![](images/sky.png){fig-alt="The same slide rendered in the Sky theme: dark text on a light blue gradient background."}
:::
...
::: {layout="[1, 20]"}
![](images/presentation-menu.png){width="41" fig-alt="Menu icon: three horizontal lines."}
...
::: {layout="[1, 20]"}
![](images/presentation-chalkboard.png){width="41" fig-alt="Chalkboard icon: an easel holding a blank board."}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](images/presentation-notes-canvas.png){width="41" fig-alt="Notes canvas icon: a paintbrush."}
...
press {{< kbd s >}} (or use the tools in the **Slide menu** button <i class="fas fa-bars ui-icon" aria-hidden="true" style="font-size: 0.8em"></i>) to open speaker view

![](images/speaker-view.png){fig-align="center" style="border: 3px solid #dee2e6;" width="780" fig-alt="Screenshot of reveal.js presentation in Speaker View. The current slide, 'Quarto Presentations with Reveal.js,' fills the left panel. The right panel shows the upcoming slide preview at the top, and the elapsed time and clock time at the bottom."}
...
Press {{< kbd r >}} (or use the tools in the **Slide menu** button <i class="fas fa-bars ui-icon" aria-hidden="true" style="font-size: 0.8em"></i>) to open scroll view
...
::: columns
::: {.column width="50%"}
![](images/jupyter-edit.png){.border .border-thick fig-alt="Screenshot of a Jupyter notebook editing a scatterplot of miles per gallon versus horsepower, colored by origin, built with Altair."}
:::

::: {.column width="50%"}
![](images/jupyter-preview.png){.border .border-thick fig-alt="Screenshot of the rendered slide in a browser tab, showing the miles-per-gallon-versus-horsepower scatterplot beneath the slide title 'Miles per Gallon.'"}
:::
:::
...
![](images/rstudio.png){.border width="900" fig-alt="Screenshot of RStudio's Presentation pane. The source editor on the left has R code for a ggplot2 scatterplot of highway mpg versus displacement; the rendered slide preview with the same plot is on the right."}
