...
```{=html}
<iframe src="demo.pdf" width="705" height="528" style="display: block; margin: 0 auto;  border: 3px solid #dee2e6;"></iframe>
```
::: footer
...
Integrated Quarto presentation preview pane

![](images/rstudio.png){.border width="750"}

::: footer
Learn more: [RStudio IDE](https://quarto.org/docs/tools/rstudio.html)
:::
