...
![](https://placekitten.com/300/300){.absolute bottom=0 right=50 width="300" height="300"}
```

```{=html}
<iframe class="reveal-demo border" src="demo/mini/absolute.html"></iframe>
```
...
```{=html}
<iframe class="reveal-demo border" src="demo/mini/stack.html"></iframe>
```
### Fit Text
...
```{=html}
<iframe class="reveal-demo border" src="demo/mini/auto-animate.html"></iframe>
```
...
```{=html}
<iframe class="reveal-demo border" height="300px;" src="demo/mini/auto-animate-code.html"></iframe>
```
### Movement Animations
...
```{=html}
<iframe class="reveal-demo border" height="300px;" src="demo/mini/auto-animate-movement.html"></iframe>
```
### Element Matching
...
```{=html}
<iframe class="reveal-demo border" height="300" src="demo/mini/auto-animate-stack.html"></iframe>
```
### Animation Settings
...
```{=html}
<iframe class="reveal-demo border" src="demo/mini/fragments.html"></iframe>
```
### Fragment Classes
...
```{=html}
<iframe class="reveal-demo border" src="demo/mini/fragments-nested.html"></iframe>
```
### Fragment Order
