...
```{.markdown .reveal-demo code-example="demo/mini/absolute.qmd"}
...
```{.markdown .reveal-demo code-example="demo/mini/stack.qmd"}
::: {.r-stack}
...
```{.markdown .reveal-demo code-example="demo/mini/auto-animate.qmd"}
## {auto-animate=true}
...
````{.markdown .reveal-demo code-example="demo/mini/auto-animate-code.qmd"}
## {auto-animate="true"}
...
```{.markdown .reveal-demo code-example="demo/mini/auto-animate-movement.qmd"}
## {auto-animate=true}
...
```{.markdown .reveal-demo code-example="demo/mini/auto-animate-stack.qmd"}
...
```{.markdown .reveal-demo code-example="demo/mini/fragments.qmd"}
::: {.fragment}
Fade in
:::
...
```{.markdown .reveal-demo code-example="demo/mini/fragments-nested.qmd"}
::: {.fragment .fade-in}
::: {.fragment .highlight-red}
