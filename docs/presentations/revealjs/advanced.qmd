...
```{=html}
<iframe class="reveal-demo border" height="300" src="demo/auto-animate-stack.html"></iframe>
```
### Animation Settings
...
```{=html}
<iframe class="reveal-demo border" src="demo/fragments-nested.html"></iframe>
```
### Fragment Order
