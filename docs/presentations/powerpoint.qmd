...
For background images, only the "stretch" mode is supported, and the background image is centered around the slide in the image's larger axis, matching the observed default behaviour of PowerPoint.
