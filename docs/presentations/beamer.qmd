...
By default, the Beamer format has `echo: false`, which means that by default, executable code cells in Beamer documents won't show their source. As with other options, you can override this behavior in the document metadata or individually in each executable cell.
