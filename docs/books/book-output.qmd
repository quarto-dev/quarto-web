...
You can disable the brand logo on the sidebar if you're using a [`_brand.yml`](/docs/authoring/brand.qmd):
...
-   Integration with Quarto's [brand system](/docs/authoring/brand.qmd) for colors and logos

### Customizing Typst Books

You can create your own Typst book format extension. See [Custom Typst Formats](/docs/output-formats/typst-custom.qmd) for details on creating format extensions.
