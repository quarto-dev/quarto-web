...
Using the Quarto `asciidoc` format, you can incorporate computational output and other features of Quarto (such as callouts, code annotations, and more) into AsciiDoc books. This section explains how.
