...
-   The [Hypothesis](https://web.hypothes.is/) commenting bar appears on the far right of the page. Note that [commenting](html-basics.qmd#commenting) is a feature available for all Quarto HTML output so appears in its own YAML key.
...
You can learn more about creating theme files in the documentation on [HTML Themes](html-themes.qmd).
