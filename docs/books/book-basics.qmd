...
<<<<<<< HEAD:docs/books/book-basics.qmd
HTML books are not that different from [Quarto Websites](website-basics.qmd) save for the fact that chapters and sections are numbered and therefore support [Cross References](crossref.qmd).
=======
...
>>>>>>> c378433b805390ff90c1dc0d3c03b6de810f086b:docs/books/book-basics.md
