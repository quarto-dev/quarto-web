...
![](/docs/websites/images/positron-create-project-command.png){.include-dark .border fig-alt="Positron command palette with Quarto: Create Project highlighted at the top of the list."}

Then, select **Book Project**:

![](images/positron-create-project-book.png){.include-dark .border fig-alt="Create Quarto Project prompt in Positron, with Book Project selected in the project type list."}
...
![](/docs/websites/images/positron-create-project-directory.png){.include-dark .border fig-alt="Project Directory Name prompt in Positron, with an empty text box for the directory name."}
...
![](images/positron-create-project-render-book.png){.include-dark .border fig-alt="The new book project open in Positron, with index.qmd in the editor and the Preview button in the editor toolbar highlighted."}
...
![](/docs/websites/images/vscode-create-project-command.png){fig-alt="The VS Code command palette with Quarto: Create Project selected."}

Then, select **Book Project**:

![](/docs/websites/images/vscode-create-project-book.png){.border fig-alt="The VS Code Create Quarto Project menu with Book Project selected."}

You'll be prompted to select a parent directory to create the project within. Then, you'll be asked to name the directory for your book project:

![](/docs/websites/images/vscode-create-project-directory.png){.border fig-alt="The VS Code prompt for the Project Directory Name."}
...
![](/docs/websites/images/vscode-create-project-render-book.png){fig-alt="The new book project open in VS Code, with index.qmd open in the editor. The pointer is on the Preview button in the editor toolbar."}
...
![](/docs/websites/images/rstudio-project-new-directory.png){.border fig-alt="RStudio New Project Wizard, Create Project step, with New Directory selected."}

![](/docs/websites/images/rstudio-project-book.png){.border fig-alt="RStudio New Project Wizard, Project Type step, with Quarto Book selected."}
:::

Then, provide a directory name and other relevant options for the book:

![](/docs/websites/images/rstudio-project-book-options.png){.border fig-alt="RStudio Create Quarto Book dialog with an empty Directory name field, a subdirectory path, an Engine menu, and options to create a git repository and use the visual markdown editor."}

Click the **Render** button to preview the book:

![](/docs/websites/images/rstudio-project-book-preview.png){fig-alt="RStudio with index.qmd open in the visual editor on the left. The rendered book preview shows in the Viewer pane on the right, with the title mybook, then the Preface chapter."}
