...
Bootstrap [buttons classes](https://getbootstrap.com/docs/4.0/components/buttons/) give you the option to turn a simple link into a button, making it more visible.<br>
For example, the following Markdown

``` markdown
[Open it](https://quarto.org/){.btn-action-primary .btn-action .btn .btn-success .btn-lg}
```

gives you back this button
