...
::: {.list-table widths="0.19310344827586,0.80689655172414" header-rows="1"}

* * Option
  * Description

* * `link-external-icon`
  * `true` to show an icon next to the link to indicate that it's external (e.g. [external](#){.external}).
