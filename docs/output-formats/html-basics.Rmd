...
There are a variety of ways to customize HTML output. The [Document Options](../authoring/document-options.md) article covers core options shared by all formats (e.g. table of contents, section numbering, syntax highlighting, etc.). This article covers some HTML specific options including:

-   Adding your own CSS styles
-   LaTeX math rendering
-   Creating self-contained HTML
-   Providing section anchor links
...
Use the `highlight-style` option to specify a syntax highlighting style:
...
See the completion documentation on [Syntax Highlighting](../authoring/document-options.md#syntax-highlighting) for details on available styles and other options.
