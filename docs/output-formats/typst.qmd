...
Cross-referenced equations in Typst can include alternative text for screen readers.
See [Alt Text for Equations](/docs/authoring/cross-references.qmd#eq-alt-text) for syntax and best practices.
