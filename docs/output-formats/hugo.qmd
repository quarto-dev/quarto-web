...
Live preview for Hugo websites is a feature of Quarto v1.2. If you want to use this feature please download the [Quarto v1.2 Pre-Release](https://quarto.org/docs/download/prerelease.html) before proceeding.
:::
...
This will automatically run `hugo serve` on your behalf. In addition, it will monitor the filesystem for changes to `.qmd` and `.ipynb` inputs and automatically re-render them when they change. The Hugo website preview will automatically navigate to any page which is updated.
