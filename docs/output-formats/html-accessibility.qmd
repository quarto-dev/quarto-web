...
To check every page of a rendered site at once, at two widths and in both color modes, use the experimental [`quarto call axe`](/docs/websites/website-accessibility.qmd) command. It runs on the command line, as a project `post-render` script, or in CI.
