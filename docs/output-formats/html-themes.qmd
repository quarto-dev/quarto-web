...
+--------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `$navbar-brand`    | The color of the 'brand' element of the navbar. The brand element is typically the site name or navbar logo, if present. Defaults to the `$navbar-fg` color.                |
+--------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `$navbar-brand-hl` | The highlight color of the 'brand' element of the navbar. The brand element is typically the site name or navbar logo, if present. Defaults to the `$navbar-hl` color.      |
+--------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
