...
Sass variables to control the appearance of the the table of contents are available only in Quarto v1.2 or greater, which you can download at <https://quarto.org/docs/download/prerelease.html>.
:::
