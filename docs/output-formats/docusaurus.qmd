...
![](images/docusaurus-code-title.png){fig-alt="Docusaurus code block titled hello.py, containing the code 1 + 1."}
...
![](images/docusaurus-code-fold.png){fig-alt="Expanded collapsible code block in Docusaurus, with a toggle arrow next to the heading Code, and the code 1 + 1 below it."}
...
![](images/docusaurus-callout.png){fig-alt="Blue info callout in Docusaurus with an exclamation-point icon and the label INFO, containing the text Note the Quarto callout syntax is used here."}
...
![](images/docusaurus-tabs.png){.border fig-alt="Tabset in Docusaurus with tabs Apple, Orange, and Banana. The Apple tab is selected, showing the text This is an apple with an apple emoji."}
...
![](images/docusaurus-mdx.png){.border fig-alt="Rendered MDX block in Docusaurus: Docusaurus GREEN highlighted in green and Rams blue highlighted in blue, followed by the sentence I can write Markdown alongside my JSX, with Markdown in bold and JSX in italics."}
