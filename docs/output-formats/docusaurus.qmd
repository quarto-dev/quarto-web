...
Support for Docusaurus websites is a recently developed feature of Quarto v1.2. If you want to use this feature please download the very latest [Quarto v1.2 Pre-Release](https://quarto.org/docs/download/prerelease.html) before proceeding (you should be sure to have v1.2.161 or greater installed).
