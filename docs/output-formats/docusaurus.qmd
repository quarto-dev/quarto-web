...
The basic concept of using Quarto with Docusaurus is that you take _computational_ markdown documents (`.qmd`) or Jupyter notebooks (`.ipynb`) and use them to generate plain markdown files (`.md`) that are rendered to HTML by Docusaurus.

**index.qmd**&nbsp;&nbsp;&nbsp;_quarto =>_&nbsp;&nbsp;&nbsp;**index.md**&nbsp;&nbsp;&nbsp;_docusaurus =>_&nbsp;&nbsp;&nbsp;**index.html**
