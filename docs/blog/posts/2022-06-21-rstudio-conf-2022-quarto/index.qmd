...
-   [**Reimagine + Collaborate + Share with Quarto**](https://rstudioconf2022.sched.com/event/11iZo?iframe=no) **(Keynote)**:
    ...
    -   this keynote is [***\[ADD ABSTRACT\]***]{.underline}.
-   [**Quarto for R Markdown users**](https://rstudioconf2022.sched.com/event/11iZa/quarto-for-rmarkdown-users?iframe=no):
...
-   [**These are a few of my favorite things (about Quarto presentations)**](https://rstudioconf2022.sched.com/event/11ibN/these-are-a-few-of-my-favorite-things-about-quarto-presentations?iframe=no):
...
-   [**Literate Programming With Jupyter Notebooks and Quarto**](https://rstudioconf2022.sched.com/event/11ibe/literate-programming-with-jupyter-notebooks-and-quarto?iframe=no):
...
-   [Websites & Books & Blogs, oh my! Creating Rich Content with Quarto](https://rstudioconf2022.sched.com/event/11ibV/websites-books-blogs-oh-my-creating-rich-content-with-quarto?iframe=no):
