...
-   [**Reimagine + Collaborate + Share with Quarto**](https://sched.co/11iZo) **(Keynote)**:
    -   Presented by [Julia Stewart Lowndes](https://jules32.github.io/) (Founder & Co-Director, Openscapes) and [Mine Çetinkaya-Rundel](http://mine-cr.com/) (\
        Developer Educator at RStudio and Professor at Duke University).
    -   Thursday July 28, 9:00am - 10:00am EDT.
    -   You might have heard Quarto is next-generation R Markdown, but have you ever wondered where the name Quarto comes from? It's the size of book page created by folding each printed sheet into four leaves. And in this talk, in four acts, we will discuss how Quarto unifies and extends the RMarkdown ecosystem and share our experiences authoring, teaching, and collaborating with Quarto. We will also highlight features of Quarto that have allowed us to reimagine our reproducible workflows and artifacts we create with minimal friction and maximal enjoyment. Full of demos showcasing authoring with Quarto in RStudio and Jupyter and weaving together narrative, R, and Python code as well as personal success stories and a lightning round of tips and tricks, this talk will help you get the most out of Quarto regardless of your background with R Markdown, the computing language(s) you use, and your tool of choice for authoring.
...
-   [**These are a few of my** ](https://rstudioconf2022.sched.com/event/11ibN/these-are-a-few-of-my-favorite-things-about-quarto-presentations?iframe=no)[**favorite**](https://sched.co/11ibN)[ **things (about Quarto presentations)**](https://rstudioconf2022.sched.com/event/11ibN/these-are-a-few-of-my-favorite-things-about-quarto-presentations?iframe=no):
