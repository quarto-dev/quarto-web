...
-   Obtaining multiple formats outputs from one source
...
In addition, the webinar featured a reproduction of a medical manuscript with Quarto. Huge thanks to Peter Higgins who pointed me to this article and the R package that contains code from the article ([**medicaldata**](https://higgi13425.github.io/medicaldata/)) and shared some starter code with me. Materials from this reproduction can be found at the links below:
...
-   Manuscript homepage: <https://mine-cetinkaya-rundel.github.io/indo-rct>
    ...
    -   You can also find a link to the Binder instance for this manuscript.[^2]
...
[^2]: The Binder instance takes a few minutes to launch, you can leave that running in a tab while you browse the rest of the manuscript in another tab.
