...
Below, we'll highlight the improved Typst support, the native Julia engine, website enhancements like draft handling and announcement bars, and a couple of shortcodes for generating placeholder content. You can see all the changes in the [Release Notes](/docs/download/index.qmd) on the download page.
