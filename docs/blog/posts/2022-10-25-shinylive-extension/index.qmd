...
Not all Shiny applications can be deployed with Shinylive (in part because not all Python packages can run in WebAssembly), but for those that can, this makes it possible to deploy the application on any web hosting service. To learn more about Shinylive, see [this page](https://shiny.rstudio.com/py/docs/shinylive.html).
