...
description: |
  A new video for highlighting some of Quarto's features that are especially useful for academics, as educators and as researchers.
categories:
  - Learn
...
[RStudio Visual Editor](/docs/visual-editor/).
...
-   [Inserting citations](/docs/visual-editor/technical.html#citations) from Zotero or from a DOI with the RStudio Visual Editor
