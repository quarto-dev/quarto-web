...
alt-text:
  featured: "Cartoon dog wizard wearing dark blue hat with red band holding magic wand creating HTML and CSS code scrolls in starry night scene."
  extensions-marketplace: "alt-text"
  quarto-extensions-home: "alt-text"
  quarto-extensions-modal: "alt-text"
  quarto-extensions-template: "alt-text"
  vscode-activity-bar: "alt-text"
  vscode-install: "alt-text"
  vscode-update: "alt-text"
  vscode-template: "alt-text"
editor:
  render-on-save: true
---
