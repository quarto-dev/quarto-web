...
summary: Bundle Typst packages with your extension for offline use
---

When developing a custom Typst format that uses packages from the Typst preview namespace (e.g., `@preview/marginalia`) or local packages (`@local`), you can bundle those packages with your extension for offline use.

The `quarto call typst-gather` command automates this process.
