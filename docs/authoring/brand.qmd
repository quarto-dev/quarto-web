...
A single logo may not work well in all locations so **brand.yml** allows you to set 3 different logos: `small`, `medium` and `large`. For example:
...
<https://posit-dev.github.io/brand-yml/brand/meta.html>
