...
Support for videos is a feature of Quarto v1.2. If you want to use this feature please download and install [Quarto v1.2](https://quarto.org/docs/download/prerelease.html) before proceeding.
:::
...
```{.default shortcodes="false" .code-overflow-scroll}
...
```{.default shortcodes="false"}
{{< video https://youtu.be/wo9vZccmqwcwidth="250" height="175" >}}
```
