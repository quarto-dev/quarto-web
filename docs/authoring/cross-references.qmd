...
### Alt Text for Equations {#eq-alt-text}

::: {.callout-note}
This feature was introduced in Quarto 1.9 and is currently available for Typst output only.
:::

You can add alternative text to cross-referenced equations to improve accessibility for screen readers.
