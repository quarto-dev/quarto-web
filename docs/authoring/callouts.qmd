...
This is an example of a callout with a title. Providing a heading is optional.

When no heading is provided the callout type will determine the expected heading (i.e., Note, Warning, Important, Tip, or Caution).
:::
