...
<table style="width:96%;"><colgroup><col style="width: 24%" /><col style="width: 71%" /></colgroup><thead><tr class="header"><th><p>Option</p></th><th><p>Description</p></th></tr></thead><tbody><tr class="odd"><td><p><code>reference-location</code></p></td><td><p>Where to place footnotes. Defaults to <code>document.</code><br />
