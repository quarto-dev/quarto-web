...
<table><colgroup><col style="width: 43%" /><col style="width: 56%" /></colgroup><thead><tr class="header"><th><p>Column</p></th><th><p>Column Names</p></th></tr></thead><tbody><tr class="odd"><td><p>Body</p></td><td><pre><code>body
body-outset
body-outset-left
...
<table><colgroup><col style="width: 44%" /><col style="width: 55%" /></colgroup><thead><tr class="header"><th><p>Column</p></th><th><p>Class Names</p></th></tr></thead><tbody><tr class="odd"><td><p>Body</p></td><td><pre><code>.column-body
.column-body-outset
