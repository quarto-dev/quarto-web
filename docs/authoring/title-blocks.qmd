...
![](images/document-title-block-banner.png){.border}
...
![](images/document-title-block-banner-custom.png){.border}
...
For more about date formats, see the Quarto [date format reference](/docs/reference/date-format.qmd).
