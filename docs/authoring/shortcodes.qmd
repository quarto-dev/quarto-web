...
|----------------------------------------------|----------------------------------------|
| [var](variables.qmd#var)                     | Print value from `_variables.yml` file |
| [meta](variables.qmd#meta)                   | Print value from document metadata     |
| [env](variables.qmd#url)                     | Print system environment variable      |
| [pagebreak](markdown-basics.qmd#page-breaks) | Insert a native page-break             |
| [include](includes.qmd)                      | Include contents of another qmd        |

This article describes how to [create your own](#custom-shortcodes) shortcodes.
