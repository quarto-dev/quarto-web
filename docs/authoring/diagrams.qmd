...
The `quarto install chromium` command is deprecated as of Quarto 1.9. It still works but displays a deprecation warning. To migrate to Chrome Headless Shell, run:
