...
If you are targeting a different service with `format: gfm` or prefer PNG or SVG output, you can use the `mermaid-dev` option to override the default behavior. For example:
