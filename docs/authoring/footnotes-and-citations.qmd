...
If your bibliography is being generated using BibLaTeX or natbib (@sec-biblatex), the bibliography will always appear at the end of the document and a the `#refs` div will be ignored.
...
``` include
../output-formats/_pdf-citations.md
```
