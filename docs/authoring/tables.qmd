...
This also allows Lua [filters](../extensions/filters.qmd) to manipulate the content of tables specified in HTML format.
For example, the above table will be converted to the following Pandoc AST which can then be used for any formats, including `pdf`:
      ...
      [ TableBody
          ...
          [ Row
              ...
              , Cell
                  ...
                  (RowSpan 1)
                  (ColSpan 1)
                  [ Plain [ Str "Regular" , Space , Str "output" ] ]
              ]
          ]
      ]
      (TableFoot ( "" , [] , [] ) [])
...
For example, consider the following section and table:
