...
It also means that if the included file has metadata, that block will take effect in all included files. In most cases, having metadata blocks in an included file will cause unexpected behavior.
