...
Scholarly articles require much more detail in their front matter than simply a title and an author. Quarto provides a rich set of YAML metadata tags to describe these details. On this page, you'll learn how to specify authors and their affiliations, article summaries like an abstract and keywords, and how to include information on copyright, licensing and funding.

Not all of these options are used in every format. Currently the JATS format makes use of the broadest set of metadata tags, so if you want to check how things render we recommend previewing with `format: jats`.
...
| `department`             | String     |                                                                                    |
+--------------------------+------------+------------------------------------------------------------------------------------+
| `address`\               | String     | Affiliation's location. Provide one of `region` or `state`,                        |
| `city`\                  |            | and any combination of the other keys.                                             |
| `region` or `state`\     |            |                                                                                    |
| `country` `postal-code`  |            |                                                                                    |
+--------------------------+------------+------------------------------------------------------------------------------------+
| `url`                    | String     | Affiliation's website. Converted to a link in many formats.                        |
+--------------------------+------------+------------------------------------------------------------------------------------+
| `isni`\                  | Numeric    | Affiliation's:\                                                                    |
| `ringgold`\              |            | [International Standard Name Identifier (ISNI)](https://isni.org/);\               |
| `ror`                    |            | [Ringgold ID](https://www.ringgold.com/ringgold-identifier/);\                     |
