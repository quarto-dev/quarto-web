...
::: {.list-table widths="0.5,0.5" header-rows="1"}
...
* * ```markdown
  ...
  * # Heading 1 {#heading-1 .heading-output}

* * ```markdown
    ## Heading 2
    ```
  
  * ## Heading 2 {#heading-2 .heading-output}

* * ```markdown
    ### Heading 3
    ```
  
  * ### Heading 3 {#heading-3 .heading-output}

* * ```markdown
    #### Heading 4
    ```
  
  * #### Heading 4 {#heading-4 .heading-output}

* * ```markdown
    ##### Heading 5
    ```
  
  * ##### Heading 5 {#heading-5 .heading-output}

* * ```markdown
    ###### Heading 6
    ```
  
  * ###### Heading 6 {#heading-6 .heading-output}
...
::: {.list-table widths="0.375,0.625" header-rows="1"}
...
* * ```markdown
  ...
  * [https://quarto.org](https://quarto.org){.uri}
...
::: {.list-table widths="0.5,0.47222222222222" header-rows="1"}
...
::: {.list-table widths="0.38888888888889,0.36111111111111" header-rows="1"}
...
::: {.list-table widths="0.375,0.375" header-rows="1"}
...
::: {.list-table header-rows="1" widths="0.48235294117647,0.51764705882353"}
...
::: {.list-table header-rows="1" widths="0.25,0.22222222222222"}
