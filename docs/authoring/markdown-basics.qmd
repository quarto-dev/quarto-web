...
If you are creating HTML output there are a wide variety of options available for code block output. See the article on [HTML Code](../output-formats/html-code.qmd) for additional details.
...
Typically, you'll use CSS and/or a [Filter](/docs/authoring/filters.qmd) along with divs and spans to provide styling or other behavior within rendered documents.
