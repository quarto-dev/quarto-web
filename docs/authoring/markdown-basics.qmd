...
- - ``` markdown
  ...
  - ::: pad-to-code-block
    ...
    <!-- a11y: alt added to the output only. The code shows the minimal figure syntax, and alt does not change how the figure looks. -->
...
- - ``` markdown
  ...
  - ::: pad-to-code-block
    ...
    <!-- a11y: no alt on purpose. This example shows that a linked image without alt text gives the link no name. -->
...
- - ``` markdown
  ...
  - ::: pad-to-code-block
    ...
    <!-- a11y: alt added to the output only. The code shows the title syntax, and alt does not change how the figure looks. -->
...
- - ``` markdown
  ...
  - ::: pad-to-code-block
    ...
    <!-- a11y: the code uses placeholder alt text. The output uses a real description. -->
