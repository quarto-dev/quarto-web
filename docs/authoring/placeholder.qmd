...
Th `{{{< placeholder >}}}` shortcode generates a placeholder image, which is incredibly useful when you're designing your website layout but the final images aren't ready yet.
