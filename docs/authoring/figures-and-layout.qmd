...
Note that if you do in fact want to place figures in the margin, you should use Quarto's built in support for [margin content](article-layout.qmd#margin-content), which will work for both LaTeX and HTML output
:::
