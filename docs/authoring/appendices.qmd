---
title: Title Blocks & Appendices
---

## Overview

HTML pages rendered with Quarto include a formatted title block at the start of the article and a formatted appendix at the end of the article. The title block contains the title, subtitle, authors, date, doi, and abstract. The appendix includes sections for citations and footnotes in the document, as well the attribution information (if specified) for the document itself.

## Title Block

A simple example title block looks like:

![](images/document-title-block.png){.border}
...
![](images/document-appendix-simple.png){.border}
...
![](images/document-appendix-full.png){.border}
...
![](images/document-appendix-reuse.png){.border}
