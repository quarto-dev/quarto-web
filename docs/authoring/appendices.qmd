---
title: Document Appendices
---

## Overview

By default, Quarto html documents include a formatted appendix at the end of the document. The appendix includes sections for citations and footnotes in the document, as well the attribution information (if specified) for the document itself. A simple example document appendix looks like:

![](images/document-appendix-simple.png){.column-page-right}
...
:   `none` disables appendex processing altogether. Content will not be processed or organized and information like 'Citation' and 'Reuse' will not be included in the document.

## Custom Appendices

Sections of your document can be added after your article by adding the `.appendix` class to any header. For example:
...
Any sections marked with the `.appendix` class will be included at the front of the appendix in the order in which they appear in the document. A more complete example appendix including documentation attribution and the above custom appendix section looks like:

![](images/document-appendix-full.png){.column-page-right}
...
![](images/document-appendix-reuse.png){.column-page-right}
