...
HTML pages rendered with Quarto include a formatted appendix at the end of the document. The appendix includes sections for citations and footnotes in the document, as well the attribution information (if specified) for the document itself. A simple example document appendix looks like:
