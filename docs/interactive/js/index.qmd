...
That covers a basic end-to-end use of OJS (see the [Penguins](examples/penguins.qmd) examples for the full source code). Below we cover a few more basics then provide links to additional articles that go into more depth.
