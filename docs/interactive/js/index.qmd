...
There are many options available to customize the appearance of `{ojs}` code cells and their output, including:

-   Showing, hiding, and collapsing code

-   Visibility and layout of outputs
