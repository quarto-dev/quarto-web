...
The creators of Observable run a hosted service at <https://observablehq.com/> where you can create and publish notebooks. Additionally, you can use Observable in standalone documents and websites via its [core open-source libraries](https://github.com/observablehq). Quarto uses these libraries along with an offline [compiler](https://github.com/asg017/unofficial-observablehq-compiler/tree/beta) to enable the use of Observable JavaScript ("OJS") within Quarto documents.
