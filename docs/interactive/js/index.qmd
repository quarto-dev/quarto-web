...
The creators of Observable run a hosted service at <https://observablehq.com/> where you can create and publish notebooks. Additionally, you can use Observable in standalone documents and websites via the [open-source libraries](https://github.com/observablehq) at its core. Quarto uses these core libraries to enable the use of Observable JavaScript ("OJS") within Quarto documents.
