...
https://github.com/observablehq/examples/tree/main/custom-live-data

One of Quarto's core capabilities is its ability to embed output from Python, R, etc. When the output produced by a Python or R computation is required in interactive documents, there are two possible simple approaches.
