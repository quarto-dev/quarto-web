...
| Example                                                        | Description                                                                                                        |
|----------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| [K-Means](https://jjallaire.shinyapps.io/kmeans-shiny-ojs/)    | Simple example of binding OJS inputs to Shiny inputs and shiny reactives to OJS plots.                             |
| [Binning](https://jjallaire.shinyapps.io/binning-shiny-ojs/)   | Demonstrates fast binning of a medium sized dataset (32mb) on the server.                                          |
| [Data Binding](https://jjallaire.shinyapps.io/data-shiny-ojs/) | Demonstrates importing a notebook from <https://observablehq.com> and binding it's data field to a Shiny reactive. |
