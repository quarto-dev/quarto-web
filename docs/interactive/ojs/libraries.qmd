...
![](images/observable-license.png){fig-alt="Header of the D3 notebook on ObservableHQ. The metadata row shows the license, ISC, next to the author and publish date."}
