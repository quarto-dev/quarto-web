...
![](images/old-faithful.png){.border fig-alt="Rendered Old Faithful document with a Number of bins slider set to 30 above a histogram of the data."}
...
![](images/iris-k-means.png){.border fig-alt="Shiny app titled Iris K-Means Clustering that fills the page width. A sidebar on the left has X Variable, Y Variable, and Cluster count inputs. A scatterplot of the clusters is on the right."}
