...
![](images/rstudio-ide.png){.border fig-alt="RStudio with old-faithful.qmd open in the editor and the Run Document button on the editor toolbar. The Viewer pane shows the rendered document with the Number of bins slider and histogram."}
...
![](images/rstudio-ide-options.png){.border fig-alt="RStudio editor toolbar with Run on Save checked. The settings menu is open and Preview in Viewer Pane is selected."}
...
If you are using RStudio you can also use the **Publish** button <kbd>![](/docs/output-formats/images/publish-button.png){width="21" fig-alt=""}</kbd> available when working with an interactive document:

![](images/rstudio-ide-publish.png){.border width="587" fig-alt="RStudio Publish to Server dialog with k-means.qmd, k-means.html, and k-means_files checked, publishing to the shinyapps.io account."}
...
If you are using RStudio you can also use the **Publish** button <kbd>![](/docs/output-formats/images/publish-button.png){width="21" fig-alt=""}</kbd> as described above in the ShinyApps documentation:

![](images/rstudio-ide-rsc-publish.png){.border width="573" fig-alt="RStudio Publish to Server dialog with k-means.qmd, k-means.html, and k-means_files checked and a Posit Connect account selected in Publish From Account."}
