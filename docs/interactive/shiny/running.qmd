...
Note that you need the [latest release](https://rstudio.com/products/rstudio/download/) of RStudio (v2022.02) in order to run Quarto interactive documents, which you can download here <https://rstudio.com/products/rstudio/download/>.
