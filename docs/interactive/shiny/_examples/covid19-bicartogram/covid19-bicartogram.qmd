...
server: 
  type: shiny
  ojs-export: [ojsDateStart, ojsDateEnd]
---
...
ojs_define(summary_data, echo_stuff)
```

```{ojs}
//| panel: sidebar
ojsDateStartEl = datePicker("2020-01-01", "2021-08-31", "2021-08-01", " Date start");
ojsDateEndEl = datePicker("2020-01-01", "2021-08-31", "2021-08-09", " Date end");
ojsDateStartVal = Generators.input(ojsDateStartEl.date)
ojsDateEndVal = Generators.input(ojsDateEndEl.date)
ojsDateStart = {
  return ojsDateStartVal.toISOString().split('T')[0];
}
ojsDateEnd = {
  return ojsDateEndVal.toISOString().split('T')[0];
}
```
