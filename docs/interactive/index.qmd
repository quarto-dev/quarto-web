...
Once you've gotten familiar with using various interactive components you may want to improve their appearance and usability by:

-   Grouping inputs into an [input panel](layout.qmd#input-panel).

-   Presenting multiple outputs in a [tabset panel](layout.qmd#tabset-panel).

-   Breaking out of the conventional article layout (centered column with margins) with a [full page layout](layout.qmd#full-page-layout).

-   Adding a [sidebar panel](layout.qmd#sidebar-panel) for inputs in a full page layout.

-   Creating custom [panel layouts](layout.qmd#panel-layout) to arrange outputs into rows and columns.

See the article on [Component Layout](layout.qmd) for additional details.
