...
Extensions are a recently released Quarto feature so you should be sure to install the [very latest version](https://quarto.org/docs/get-started/) of Quarto (at least v1.0.14) before proceeding.
