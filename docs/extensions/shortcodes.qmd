...
1.  Be sure you have a [very recent](https://github.com/quarto-dev/quarto-cli/releases/latest) version of Quarto CLI (shortcode extensions require v1.0.14 or greater).
