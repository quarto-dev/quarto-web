...
Version 1.2 of Quarto includes many improvements for extension development so if you are building an extension we strongly recommend that you download and install [Quarto v1.2](https://quarto.org/docs/download/prerelease.html) before proceeding.
:::
...
1.  Install the latest version of [Quarto v1.2](https://quarto.org/docs/download/prerelease.html)
