...
Various utility functions are provided, the most of important of which is the `quarto.utils.dump()` function which is indispensable for debugging.
...
| Function                               | Description                                                                                                                                                                                                                                               |
|------------------------------------|------------------------------------|
| `quarto.doc.addHtmlDependency(dep)`    | Add an HTML dependency (additional resources and content) to a document. See docs on the [dependency object](#dependency-object) below for additional details.                                                                                            |
