...
<ul id="index-chooser" class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link" href="listing-filters.html">
      <i class="bi bi-gear" aria-hidden="true"></i>Shortcode/Filter
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="listing-journals.html">
      <i class="bi bi-journal-text" aria-hidden="true"></i>Journal Articles
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="listing-formats.html">
      <i class="bi bi-file-earmark-richtext" aria-hidden="true"></i>Custom Formats
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="listing-revealjs.html">
      <i class="bi bi-easel3" aria-hidden="true"></i>Revealjs
    </a>
  </li>
</ul>
</nav>
