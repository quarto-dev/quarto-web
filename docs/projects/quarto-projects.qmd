...
You can use the `quarto run` command to run a JavaScript/TypeScript, Lua, R, or Python script. For example:
...
|----------|----------------------------------------------------------------------------------------|
| JS / TS  | [Deno](https://deno.land/) (embedded in Quarto)                                        |
...
Using JavaScript, TypeScript, or Lua enables you to create scripts with no additional installation requirements. On the other hand, if your project is already using Python or R then scripts in those languages might be more convenient.
