...
You can use the `quarto run` command to run a Lua, R, or Python script. For example:
...
Using Lua enables you to create scripts with no additional installation requirements. On the other hand, if your project is already using Python or R then scripts in those languages might be more convenient.
