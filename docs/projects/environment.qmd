...
Returning to the example of AWS credentials, this `_environment.example` file provides documentation that these credentials will be required to render the project locally:
