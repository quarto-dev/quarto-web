...
Project environment variables are a new feature in Quarto v1.2. Before attempting to try it out, please download and install Quarto v1.2 from  <https://quarto.org/docs/download/prerelease.html>.
:::
