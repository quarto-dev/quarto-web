...
If you are using Quarto within RStudio it is strongly recommended that you use the preview release of RStudio from <https://www.rstudio.com/products/rstudio/download/preview/> (the documentation below assumes you are using this build).
