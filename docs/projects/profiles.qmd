...
Project profiles are a new feature in Quarto v1.2. Before attempting to try it out, please download and install Quarto v1.2 from  <https://quarto.org/docs/download/prerelease.html>.
:::
...
``` {.yaml filename="_quarto-english.yml"}
project:
  title: "My Website"
lang: en
```

``` {.yaml filename="_quarto-french.yml"}
project:
