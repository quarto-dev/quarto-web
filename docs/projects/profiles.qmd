...
Note in this example we specify the group as a list item beneath `profile-group`: this demonstrates the possibility of defining multiple profile groups within a project.
