...
In this tutorial we'll show you how to author Quarto documents using the VS Code notebook editor.
...
To create a Raw cell, add a cell at the top of the notebook and set its type to Raw using the language menu at the bottom right of the code cell:

![](images/vscode-raw-cell.png){.border}
...
![](images/vscode-format.png){.border}
...
![](images/vscode-format-options.png){.boder}
...
![](images/vscode-formats.png){.border}
...
![](images/vscode-sections.png){.border}
...
You can add LaTeX equations to markdown cells within VS Code.
...
![](/docs/get-started/authoring/images/vscode-equation.png){.border}

Equations are rendered when you run the cell.

![](/docs/get-started/authoring/images/vscode-equation-render.png){.border}
...
![](/docs/get-started/authoring/images/vscode-citations.png){.border}
...
![](/docs/get-started/authoring/images/vscode-crossref.png){.border}
...
![](/docs/get-started/authoring/images/vscode-callout.png){.border}
...
![](/docs/get-started/authoring/images/vscode-callout-render.png){.border}
...
![](images/vscode-layout.png){.border}
