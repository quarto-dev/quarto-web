...
If you would like to follow along step-by-step in your own environment, make sure that you have the [latest release](https://rstudio.com/products/rstudio/download/) of RStudio (v2022.02), which you can download [here](https://rstudio.com/products/rstudio/download/), installed.
