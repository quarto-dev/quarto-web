...
Once you have LaTeX setup, click the **Render** button ![](images/rstudio-render-button.png){.ui-icon alt="" width="25" height="20"} (or use the keyboard shortcut ⇧⌘K).
...
Clicking the **Render** button ![](images/rstudio-render-button.png){.ui-icon alt="" width="25" height="21"} (or using the keyboard shortcut <kbd>⇧⌘K</kbd>) in RStudio will render the document to the first format listed in the YAML.
...
Note that the **Render** button ![](images/rstudio-render-button.png){.ui-icon alt="" width="25" height="21"} also has a drop down menu that enables you to render to any of the formats listed in YAML front matter:

![](images/rstudio-render-formats.png){.border fig-alt="RStudio editor toolbar with the Render button's dropdown menu open, showing three options: Render HTML, Render PDF, and Render MS Word, matching the formats listed in the YAML."}
...
![](/docs/get-started/authoring/images/rstudio-equation-render.png){.border fig-alt="LaTeX source for an equation with RStudio's live-rendered preview of the equation below it."}
...
Once your document is rendered to HTML, you can publish to [RPubs](https://rpubs.com/) (a free service from RStudio for sharing documents on the web) simply by clicking the **Publish** button ![](images/rstudio-publish-button.png){.ui-icon alt="" width="25" height="23"} on the editor toolbar or preview window.
