...
3.  Download the Quarto document (`.qmd`) below, open it in RStudio, and click the **Render** button ![](images/rstudio-render-button.png){.ui-icon alt="" width="25" height="20"}.
...
Use the **Render** button ![](images/rstudio-render-button.png){.ui-icon alt="" width="25" height="20"} in the RStudio IDE to render the file and preview the output with a single click or keyboard shortcut (⇧⌘K).
...
In addition to rendering the complete document to view the results of code chunks, you can also run each code chunk interactively in the RStudio editor by clicking the **Run Current Chunk** button ![](https://d33wubrfki0l68.cloudfront.net/18153fb9953057ee5cff086122bd26f9cee8fe93/3aba9/images/notebook-run-chunk.png){.ui-icon alt="" width="20" height="13"} or the keyboard shortcut (⇧⌘⏎).
...
![](images/rstudio-text.png){.border fig-alt="Text portion of the linked example document titled \"Penguins, meet Quarto!\", with an annotation that reads \"Text\"." fig-align="center"}
