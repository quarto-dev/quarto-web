...
This will handle markdown well, but executable code blocks may not be highlighted in their native language (this is because Quarto uses a special syntax for executable code).

There are Quarto syntax highlighting modes available for several editors that provide additional support for Pandoc markdown (e.g citations) and handle executable code blocks correctly.
...
If you want to follow along step-by-step in your own environment, create a new file named `hello.qmd` and copy this code into it:
