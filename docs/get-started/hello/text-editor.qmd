...
![](images/text-editor-quarto-preview.png){.border .column-body-outset-right fig-alt="On the left: A text editor with a document titled Quarto Basics open, containing some text and a code cell. On the right: Rendered version of the same document, including the code cell's output, a line plot on a polar axis."}
...
![](images/quarto-preview.png){.border fig-alt="Rendered version of the earlier document in a web browser." width="500"}

You might want to position your editor and the browser preview side-by-side so you can see changes as you work.

![](images/text-editor-quarto-preview.png){.border .column-body-outset-right fig-alt="Side-by-side preview of the text editor on the left and live preview in the browser on the right."}
