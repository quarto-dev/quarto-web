...
Create a new directory to work within and copy the notebook into this directory.
Then, switch to this directory in a terminal, install notebook dependencies (if necessary), and open Jupyter Lab to get started working with the notebook.
The commands you can use to accomplish these tasks are given in the table below.
