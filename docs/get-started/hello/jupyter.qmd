...
Create a new directory to work within and copy the notebook into the directory. Switch to this directory in a terminal, install tutorial dependencies (if required), then open Jupyter Lab so we can start working with the notebook:
