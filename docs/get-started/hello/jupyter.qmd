...
Change some of the code, running the changed cell, then save the notebook.
...
You'll notice that the code is shown above the plot (where previously it was hidden with a "Code" button that could be used to show it).
...
One new twist are the options you see at the top of the cell (`label` and `fig-cap`).
