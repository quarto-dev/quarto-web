...
+=============+===============================================================================+
| Mac/Linux   | ```                                                                           |
|             | python3 -m pip install jupyter jupyterlab matplotlib plotly jupyterlab-quarto |
|             | python3 -m jupyter lab build                                                  |
|             | python3 -m jupyter lab hello.ipynb                                            |
|             | ```                                                                           |
+-------------+-------------------------------------------------------------------------------+
| Windows     | ```                                                                           |
|             | py -m pip install jupyter jupyterlab matplotlib plotly jupyterlab-quarto      |
...
::: callout-note
The above commands will also install the [Quarto JupyterLab extension](/docs/tools/jupyter-lab-extension.qmd), which improves the rendering of markdown cells containing Quarto specific markdown.
