...
![](images/vscode-basics.png){fig-alt="A notebook titled Quarto Basics containing some text, a code cell, and the result of the code cell, which is a line plot on a polar axis."}
...
![](images/ipynb-how-it-works.png){style="margin-left: 15px;" fig-align="left" width="516"}
...
You'll see that the Quarto preview updates as well.
