...
::: {.callout-note}
When using `Jupyter` as the engine, you need to install the Jupyter extension from within the **Extensions** tab in VS Code, from the [Extension Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.jupyter).
:::
