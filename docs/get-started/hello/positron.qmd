...
2.  Download the Quarto document (`.qmd`) below, open it in Positron.
    ...
    <i class="bi bi-download"></i> [Download hello.qmd](positron-r/_hello.qmd){download="hello.qmd"}
    :::
...
2.  Download the Quarto document (`.qmd`) below, open it in Positron.
    ...
    ::: {.callout appearance="minimal"}
    <i class="bi bi-download"></i> [Download hello.qmd](positron-python/_hello.qmd){download="hello.qmd"}
    :::
