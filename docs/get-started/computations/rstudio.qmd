...
```{=}
The plots in Figure @fig-mpg show the relationship between 
city and highway mileage for 38 popular models of cars.
In Figure @fig-mpg-1 the points are colored by the number 
of cylinders while in Figure @fig-mpg-2 the points are colored 
