...
If you would like to follow along step-by-step in your own environment, download the Quarto document (`.qmd`) below, open it in RStudio, and click the **Render** button ![](images/rstudio-render-button.png){.ui-icon alt="" width="25" height="20"} (or use the keyboard shortcut ⇧⌘K).
