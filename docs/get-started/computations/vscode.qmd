...
![](images/vscode-computations.png){.border alt=""}
...
![](images/vscode-computations-preview.png){.border fig-alt="Side-by-side preview of notebook on the left and live preview in the browser on the right."}
...
![](images/vscode-figure-options.png){.border fig-alt="Code cell with label and fig-cap options added, as well as a call to set the figure size explicitly."}
