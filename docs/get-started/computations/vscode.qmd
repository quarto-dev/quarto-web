...
<i class="bi bi-journal-code"></i> [Download computations.ipynb](_computations-vscode.ipynb){download="computations.ipynb"}
:::
...
![](images/vscode-computations.png){.border}

Next, create a new Terminal (either externally or within VS Code) to use for Quarto commands.

Now, run `quarto preview` in the terminal and position VS Code side-by-side with the browser showing the preview:

``` bash
quarto preview computations.ipynb
```

![](images/vscode-computations-preview.png){.border}
...
![](images/vscode-execute-echo-false.png){.border}
...
![](images/vscode-code-fold.png){.border}
...
![](images/vscode-code-tools.png){.border}
...
![](images/vscode-figure-options.png){.border}
...
Let's plot another year side-by-side for comparison and add a caption and subcaptions.
...
Copy and paste the options outlined below into the notebook if you want to try them locally:
