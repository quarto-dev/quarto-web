...
This tutorial will make use of the `matplotlib` and `plotly_express` Python packages.
...
Then, execute the **Quarto: Render** command. You can alternatively use the <kbd>Ctrl+Shift+K</kbd> keyboard shortcut, or the **Render** button at the top right of the editor:
...
Re-render the document and the preview will update to show the output with no code.
