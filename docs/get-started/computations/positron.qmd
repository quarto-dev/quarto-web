...
![](images/positron-figure-r.png){.include-dark .border .column-page-right fig-alt="Positron with computations.qmd open. On the left is the Editor. Compared to earlier images on the page, the code cell shows the added fig-cap and fig-alt options. On the right is the rendered version of the document. Below the figure is a caption."}

## Python

![](images/positron-figure-python.png){.include-dark .border .column-page-right fig-alt="Positron with computations.qmd open. On the left is the Editor. Compared to earlier images on the page, the code cell shows the added fig-cap and fig-alt options. On the right is the rendered version of the document. Below the figure is a caption."}
