...
If you want to follow along step-by-step in your own environment, create a `computations.qmd` file and copy this code into it:
...
![](images/text-editor-computations-preview.png){.border .column-page-outset-right}
...
![](images/text-editor-code-tools-preview.png){.border}
