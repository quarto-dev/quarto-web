...
![](images/jupyter-computations.png){.border alt=""}
...
\``{.markdown .visually-hidden`{{python}} #\| label: fig-limits #\| fig-cap: "Errorbar limit selector"

import matplotlib.pyplot as plt

fig = plt.figure() fig.set_size_inches(12, 7)
