...
![](images/quarto-basics/penquins-meet-quarto.png){.column-page fig-alt="RStudio IDE with a Quarto document titled \"Hello Quarto!\" open on the left side and a blank viewer pane on the right side."}
...
![](images/quarto-basics/visual-source-editor.png){.column-page fig-alt="On the left: Document in the visual editor. On the right: Same document in the source editor."}

Notice that the file contains three types of content:

-   An (optional) YAML header surrounded by fences comprised of three dashes (`---`):

![](images/quarto-basics/yaml.png){.column-body-outset fig-alt="YAML of the of the linked example document titled \"Penguins, meet Quarto!\", with annotation that reads \"YAML\"."}

-   R code chunks identified with `{r}` with (optional) chunk options, in YAML style, identified by `#|` at the beginning of the line:

![](images/quarto-basics/chunk.png){.column-body-outset fig-alt="The first code chunk of the of the linked example document titled \"Penguins, meet Quarto!\", with annotation that reads \"Code chunk\"."}

-   Text with formatting, including section headers, hyperlinks, an embedded image, and an inline code chunk:

![](images/quarto-basics/text.png){.column-body-outset fig-alt="Text portion of the of the linked example document titled \"Penguins, meet Quarto!\", with annotation that reads \"Text\"."}
...
![](images/quarto-basics/render-on-save.png){.column-body-outset fig-alt="Top of the editor in the RStudio IDE with \"Render on Save\" checked"}
...
![](images/quarto-basics/inline-output.png){.column-body-outset fig-alt="Run a code chunk and display output inline" fig-align="center" width="700"}
