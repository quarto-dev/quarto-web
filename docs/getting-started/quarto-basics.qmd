...
The output formats section provides additional details on creating [HTML](../output-formats/html-basics.qmd), [PDF](../output-formats/pdf-basics.qmd), and [MS Word](../output-formats/ms-word.qmd) documents, as well as describes a few special output types including [Presentations](../presentations/index.qmd), [EPUBs](../output-formats/epub.qmd), and pages in [Hugo](../output-formats/hugo.qmd) static sites.
