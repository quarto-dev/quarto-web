...
1. The traditional source code editor for editing `.qmd` documents as text.

2. The [Visual Editor](/docs/visual-editor/vscode/index.qmd) for editing `.qmd` documents using a word-processor style interface.

3. The [Notebook Editor](/docs/tools/vscode-notebook.qmd) for editing Jupyter notebooks that you will render with Quarto.
...
1. The [Visual Editor](/docs/visual-editor/vscode/index.qmd) for editing `.qmd` documents using a word-processor style interface.

2. The [Notebook Editor](/docs/tools/vscode-notebook.qmd) for editing Jupyter notebooks that you will render with Quarto.
