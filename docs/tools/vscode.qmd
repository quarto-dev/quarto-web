...
{{< include _vscode-spell-checking.md >}}
...
![](/docs/authoring/images/vscode-graphviz.gif){.border fig-alt="A Quarto document being edited in Visual Studio Code, with a live preview of the currenly edited diagram shown in a pane to the right"}
...
![](images/vscode-workspace-symbols.png){.border fig-alt="Quarto document in VS Code with command pallete open showing the files in the project with the entered term, 'margin'."}
