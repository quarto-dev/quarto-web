---
title: VS Code
description: "Quarto can render Jupyter notebooks represented as plain text (.qmd) or as a normal notebook file (.ipynb). One benefit of using .ipynb is that you can use the VS Code notebook interface as your editor."
---

## Overview

Quarto can render Jupyter notebooks represented as plain text (.qmd) or as a normal notebook file (.ipynb). One benefit of using .ipynb is that you can use the [VS Code Jupyter Notebook UI](https://code.visualstudio.com/docs/datascience/jupyter-notebooks) as your editor.

Here is the "Hello, Quarto" example from the homepage inside VSCode:

![](images/vscode.png){.border}
...
![](images/vscode-markdown.png){.border}
...
![](images/vscode-cell-options.png){.border}
