...
![](./images/neovim-code-completion.png){fig-alt="A qmd file open in Neovim. The cursor is inside a Python code cell after the letters pri. A completion menu lists print, printoptions, and ProfileFunction, and each entry is marked with an otter icon."}
