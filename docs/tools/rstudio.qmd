...
The currently [preview release](https://www.rstudio.com/products/rstudio/download/preview/) of RStudio includes support for editing and preview of Quarto documents. This works for plain markdown as well as both the Knitr and Jupyter engines.
...
You can download the RStudio preview release from <https://www.rstudio.com/products/rstudio/download/preview/>.
