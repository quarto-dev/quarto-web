...
The [current release](https://www.rstudio.com/products/rstudio/download/) of RStudio includes support for editing and preview of Quarto documents. This works for plain markdown as well as both the Knitr and Jupyter engines.
...
You can download the latest release of RStudio from <https://www.rstudio.com/products/rstudio/download/>.

### Creating Documents

Use the **File :** **New File : Quarto Document...** command to create new Quarto documents:

![](images/new-quarto-doc.png){width="529" .border fig-alt="The 'New Quarto Document' dialog menu in RStudio."}
