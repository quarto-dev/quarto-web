...
The quarto JuptyerLab extension enables JupyterLab Notebooks which use Quarto markdown to properly display the contents of the markdown cells. You can install the Quarto JupyterLab extension one of two ways:
