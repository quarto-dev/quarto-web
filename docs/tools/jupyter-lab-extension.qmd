...
![](images/jupyter-lab-extension.png){.border width="50%" fig-alt="A notebook named penguins.ipynb open in JupyterLab. The Quarto markdown cells show as a rendered title block, Palmer Penguins by Norah Jones of Macalester College, followed by the YAML front matter in a box and a Note callout."}
:::
