...
[Positron](https://positron.posit.co){target="_blank"} bundles both the Quarto CLI and the VS Code Quarto extension so it comes ready to work with Quarto out-of-the-box.
