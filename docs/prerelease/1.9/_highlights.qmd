...
- PDF Accessibility:
  ...
  - [Image alt text for PDF accessibility](/docs/output-formats/pdf-basics.qmd#pdf-standard): Alt text from markdown captions and `fig-alt` attributes now passes through to PDF output for screen reader support in both LaTeX and Typst formats.

  - [Alt text for equations in Typst](/docs/output-formats/typst.qmd#equation-alt-text): Provide  descriptive text for equations using the `alt` attribute.
