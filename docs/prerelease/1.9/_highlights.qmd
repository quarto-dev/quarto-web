...
- [Alt text for equations in Typst](/docs/authoring/cross-references.qmd#eq-alt-text): Improve accessibility of cross-referenced equations by providing descriptive text for screen readers using the `alt` attribute.
