...
The values you provide for these elements will typically be used as the maximum value for a grid column, and any minimum or scaling sizes will be derived from that maximum value. You may specify any valid positive CSS `length` for the column width value.
