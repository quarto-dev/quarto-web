...
The default HTML annotation style displays annotations in a list below the code block. Clicking on the annotation number in the list highlights the relevant lines in the code. Other [HTML styles](#html-styles) hide the annotations, revealing them in a tooltip when a user hovers or selects a marker.

The PDF format also numbers annotations and displays the annotation text below the code. In other formats, rather than numbering annotations, annotations are labelled with the line of code (or lines of code) to which the annotation text applies.
...
To add code annotation to a code block, you need to add two things: specially formatted code comments to your code, and an ordered list below your code with your annotation content. Read more in [Annotation Syntax](#annotation-syntax).
...
2.  An ordered list that appears immediately after the code cell which includes the contents of each annotation. Each numbered item in the ordered list will correspond with the line(s) of code with the same annotation number.
...
:   Code annotation text will be displayed when the user hovers over the annotation marker for a line of code. ![](images/annote-hover.png){width="90%" fig-alt="Screenshot of output in PDF format showing code annotation."}
