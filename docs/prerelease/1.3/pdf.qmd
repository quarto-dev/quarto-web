...
- [Remote Images](/docs/output-formats/pdf-basics.qmd#svg-images)
...
-   On MacOS, you can use Homebrew (<https://formulae.brew.sh/formula/librsvg>) `brew install librsvg`{spellcheck="false"}
