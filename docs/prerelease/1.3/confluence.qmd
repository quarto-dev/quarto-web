...
You'll be walked through the same steps as publishing a single document, [setting up an account](#setting-up-account), if needed, and [selecting a destination](#selecting-destination) for your project on Confluence, before finishing with your project being published to Confluence.
...
Here are the markdown content types currently not supported:
