...
Starting in Quarto v1.3, you can control the width of the layout components in HTML documents. For example, for a website that includes figures in the margin, it might make sense to devote more space to the margin: 
...
This change can be made by setting the `grid` option in the `_quarto.yml` file:
