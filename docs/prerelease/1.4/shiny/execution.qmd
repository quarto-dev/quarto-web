...
| `context: server`       | Output of cell is not included in HTML UI, and will execute for each new client session.                                        |
| `context: server-setup` | Output of cell is not included in HTML UI, and will execute at server startup.                                                  |
: {tbl-colwidths="[40,60]"}
