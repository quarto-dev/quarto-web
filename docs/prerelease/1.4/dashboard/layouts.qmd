...
This layout is a simple stack of two charts. This dashboard fills the page and allocates height evenly accross the two charts.
...
Here we use the `height` option to allocate more space to the top chart:
...
You can include tabsets are arbitrarirly deep levels. Here we include a tabset within a column of a top level row.
