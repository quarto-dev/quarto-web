...
1.  Download and install the [latest pre-release](https://quarto.org/docs/download/prerelease) of Quarto 1.4

2.  Download and install the latest version of the [Typst CLI](https://github.com/typst/typst#installation) (v0.2 or later is required).

3.  Create a document that uses `format: typst`. For example:
