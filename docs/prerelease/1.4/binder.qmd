...
Keep reading for a more detailed walkthrough of the process, or skip ahead to learn about specifying [Dependencies](#dependencies) or the specific [Configuration Files](#configuration-files) that may be generated.
...
You can read more about using these environments with Quarto in [Virtual Environments](/docs/projects/virtual-environments.qmd).
