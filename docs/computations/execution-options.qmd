...
If your quarto document includes both `{python}` and `{r}` code blocks, then quarto will automatically use [reticulate](https://rstudio.github.io/reticulate/) to execute the python content.
:::
