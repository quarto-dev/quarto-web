...
![light rendering](images/renderings-light-mode.png){fig-alt="The code cell and a scatterplot of 1:10 with black points and axes on a white background."}

![dark rendering](images/renderings-dark-mode.png){fig-alt="The code cell and a scatterplot of 1:10 with white points and axes on a black background."}
