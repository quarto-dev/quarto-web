...
Quarto Dashboards make it easy to create interactive dashboards using Python, R, and Observable:
...
Next, check out the [Dashboard Components](basics.qmd) article.

This will provide you with a broad overview of the core concepts and capabilities of dashboards along with documentation on all of the main components used within dashboards.
