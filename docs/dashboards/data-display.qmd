...
![](images/altair.png){fig-alt="Screenshot of a card titled Iowa Electricity. The card contains an area chart of net generation by year from 2001 to 2017, with overlapping areas for Fossil Fuels, Nuclear Energy, and Renewables."}
