...
You can use [Shiny for Python](https://shiny.posit.co/py/) add add interactivity to a Python based dashboard.  For example, here's a very simple interactive dashbboard you might build using Shiny:
