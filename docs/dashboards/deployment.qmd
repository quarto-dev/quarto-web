...
- [Posit Connect](https://posit.co/products/enterprise/connect/) (an on-premises commerical server product).
...
{{< include /docs/prerelease/1.4/shiny/_shiny-deployment.md >}}
