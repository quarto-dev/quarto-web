...
The [Quarto VS Code Extension](https://open-vsx.org/extension/quarto/quarto) provides integrated support for previewing Shiny interactive documents (just use the **Quarto: Preview** command as you normally would with a static document):
