...
As an alternative to sidebars, you can also layout inputs horizontally, or even attach them directly to cards. See the article on [Input Layout](../inputs.qmd) for further details.
