...
![](/docs/dashboards/images/toolbar.png){.border fig-alt="A Penguin Bills dashboard with a toolbar across the top. The toolbar has Variable and Distribution dropdown menus and a Show rug marks checkbox. Below the toolbar is a density plot of bill length by species."}
...
![](/docs/dashboards/images/toolbar-inline.png){.border fig-alt="A Palmer Penguins dashboard with two columns. The left column has a toolbar with a Distribution dropdown menu and a Show rug marks checkbox, and a density plot below it. The right column has a data table and no toolbar."}
...
![](/docs/dashboards/images/toolbar-bottom.png){.border fig-alt="A Penguin Bills dashboard with a histogram of bill length by species. Below the histogram is a toolbar with Variable and Distribution dropdown menus and a Show rug marks checkbox."}
