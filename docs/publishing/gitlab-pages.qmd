...
The pipeline will render your content and publish it to GitLab Pages using the [Tier 0](https://gitlab.com/quarto-forge/docker#tier-0) Docker image from [Quarto Forge](https://gitlab.com/quarto-forge). Docker images in this tier are the best option to GitLab CI if you are not doing any computation.
