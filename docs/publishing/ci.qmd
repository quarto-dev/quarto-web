...
If you want to execute code locally then only do markdown rendering on CI, you can use Quarto's [freeze](/docs/projects/code-execution.html#freeze) feature. For example, if you add this to your `_quarto.yml` file:
