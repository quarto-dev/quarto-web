...
provider:
  id: netlify
  name: Netlify
  publish-url: "https://tubular-unicorn-97bb3c.netlify.app"
---
...
![](images/netlify-control-panel.png){fig-alt="Netlify site card with Site settings and Domain settings buttons."}

Within **Site settings**, click the **Change site name** button to specify a different sub-domain:

![](images/netlify-site-settings.png){fig-alt="Netlify Site information panel with a Change site name button."}
...
![](images/netlify-import-project.png){fig-alt="Import an existing project dialog showing the Connect to Git provider step, with buttons for GitHub, GitLab, Bitbucket, and Azure DevOps."}
...
![](images/netlify-build-settings.png){.border fig-alt="Basic build settings with an empty Build command field and _site entered in the Publish directory field."}
...
2.  Add the Netlify personal access token to your repository's action **Secrets** (accessible within repository **Settings**). You will see a **New repository secret** button at the top right:
    ...
    ![](images/netlify-gh-action-secret.png){.border fig-alt="GitHub New repository secret form with Name and Value fields filled in, and an Add secret button."}
