...
We'll cover both of these techniques below.

::: callout-note
Quarto Pub is a free service for smaller scale websites (sites can be no larger than 100 MB and have a *soft* limit of 10 GB of bandwidth per month). If you want to host larger sites on a custom domain you should consider a service like [Netlify](netlify.qmd).
:::
