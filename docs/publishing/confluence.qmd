...
The `confluence-html` format supports nearly all of the standard Quarto markdown content types, including equations, tables, tabsets, callouts, and cross references. Here are the markdown content types currently not
