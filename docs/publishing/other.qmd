...
## GitHub Pages {data-link="GitHub Pages"}
...
## RStudio Connect {data-link="RStudio Connect"}
...
You should be running the [latest release](https://rstudio.com/products/rstudio/download/) of RStudio (v2022.02) if you want to publish Quarto websites. The preview release has many other Quarto related enhancements so is highly recommended even if you aren't using the publishing features.
