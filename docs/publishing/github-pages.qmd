...
![](images/gh-pages-docs-dir.png){.border fig-alt="GitHub Pages settings with Source set to Deploy from a branch, branch set to main, and folder set to /docs, next to a Save button."}
...
![](images/gh-pages-user-site.png){.border fig-alt="GitHub Pages settings with the Source branch dropdown set to gh-pages and the folder set to /(root)."}
