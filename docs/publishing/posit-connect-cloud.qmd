...
provider:
  id: posit-connect-cloud
  name: Posit Connect Cloud
  publish-url: "https://connect.posit.cloud/content/5f3abafe-68f9-4c1d-835b-9d668b892001"
  authorization:
    enabled: true
    description: "A browser will open to authenticate using your Posit account:"
    prompt: |
      ? Authorize (Y/n) ›
