...
Use the <kbd><img src="images/citation_2x.png" width="15" height="14"/></kbd> toolbar button or the {{< kbd mac=Shift-Cmd-F8 win=Shift-Ctrl-F8 linux=Shift-Ctrl-F8 >}} keyboard shortcut to show the **Insert Citation** dialog:
