...
| `nav-buttons` | Buttons to appear on the right side oft the navigation bar. Use `linkedin`, `facebook`, `reddit`, `twitter`, `github`, or a custom [Nav Item](/docs/reference/projects/websites.html#nav-items). |
...
[Value Boxes](/docs/dashboards/components.qmd#value-boxes) support the following options:
