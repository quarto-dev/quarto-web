...
- Markdown authoring with equations, citations, cross-references, sub-figures, layout panels, callouts, and more.
...
![](docs/getting-started/images/hello-quarto.png)
